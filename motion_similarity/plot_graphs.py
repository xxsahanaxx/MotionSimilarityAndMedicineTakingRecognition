...
# plt.figure(1)
# plt.plot(df1['epoch'], LSTMlosses, linewidth=1.2)
# plt.plot(df2['epoch'], GRUlosses, color='g', linewidth=1.2)
# plt.title('Training Loss Curves of LSTM vs GRU')
# plt.xlabel('Epochs')
# plt.ylabel('Magnitude')
# plt.axhline(y=0.25, color='r', linewidth=1, linestyle='-')
...
# plt.figure(2)
# plt.plot(df1['epoch'], LSTMaccuracies, linewidth=1.2)
# plt.plot(df2['epoch'], GRUaccuracies, color='g', linewidth=1.2)
# plt.title('Training Accuracy Curves of LSTM vs GRU')
# plt.legend(['LSTM','GRU'])
# plt.xlabel('Epochs')
# plt.ylabel('Magnitude')
